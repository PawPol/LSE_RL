...
sample-noise advantage. A risk-sensitive evaluator (CVaR, exponential
utility, variance-penalized return) in principle witnesses the safe-eval
advantage --- but exact policy evaluation under the safe objective
already demonstrates the gap without appealing to an RL sampler.
